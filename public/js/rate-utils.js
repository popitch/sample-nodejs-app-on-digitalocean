...
const 
    EXDIR_GROUPS = [{"id":1,"Name":"Электронные деньги"},{"id":2,"Name":"Балансы криптобирж"},{"id":3,"Name":"Интернет-банкинг"},{"id":4,"Name":"Денежные переводы"},{"id":5,"Name":"Наличные деньги"}],
